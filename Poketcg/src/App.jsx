  ...
  return (
    <div className="app">
      ...
      <div className="title-block" aria-hidden="true">
        ...
        <svg className="decor-svg" style={{ left: '36px', top: '106px' }} viewBox="0 0 397 85" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <svg className="decor-svg" style={{ left: '36px', top: '-56px' }} viewBox="0 0 397 85" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
